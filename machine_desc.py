...
class CMEModule:
    ...
    def options(self, context, module_options):
        '''
        MACHINE-DESC - Specify a machine description to filter on
        '''
    ...
    name = 'MACHINE-DESC'
    description = 'Retrieves machines containing the specified description'
    ...
    def on_login(self, context, connection):
        ...
        for item in resp:
            ...
            try:
                ...
                pass
        if len(answers) > 0:
            context.log.success('Found the following machines: ')
